...
//import org.uguess.android.dashboard.WidgetProvider.InfoWidget;
//import org.uguess.android.dashboard.WidgetProvider.TaskWidget;

import com.android.anu.dashboard.WidgetProvider.InfoWidget;
import com.android.anu.dashboard.WidgetProvider.TaskWidget;
...
public final class SysInfoManager extends ListFragment implements Constants
{
	...
	public boolean onOptionsItemSelected( MenuItem item )
	{
		...
		else if ( item.getItemId( ) == MI_ABOUT )
		{
			...
			new AlertDialog.Builder( ctx ).setTitle( "Anu Dashboard Of Process")
