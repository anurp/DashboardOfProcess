 ...
 * ProcessManager
 */
public final class PastProcessManager extends ListFragment implements Constants
{
    ...
    {
        rootView = inflater.inflate( R.layout.past_proc_list_view, container, false );
        ...
        String[] planets = new String[] { "mv", "cd", "ls -l", "unzip",
                "firefox", "tar"};
        ArrayList<String> planetList = new ArrayList<String>();
        planetList.addAll(Arrays.asList(planets));

        // Create ArrayAdapter using the planet list.
        listAdapter = new ArrayAdapter<String>(getActivity(), R.layout.past_proc_list,R.id.txt_pastproc_name,planetList);
/**
...
//        final ProcessItem rap = (ProcessItem) l.getItemAtPosition( position );
    ...
    //
    //
    //   final String pastitem = (String) l.getItemAtPosition(position);

        final String pastitem = (String) getListAdapter().getItem(position);
        Activity ctx = getActivity();
     //   Toast.makeText(getActivity(), pastitem + " selected", Toast.LENGTH_LONG).show();
    ...
    void handlePastAction(final String pastitem,int action)
    {
        //
       // Toast.makeText(getActivity(), pastitem + " selected", Toast.LENGTH_LONG).show();
        ...
        switch(action)
        {
            case 1 :
                ...
                StringBuffer sb = new StringBuffer( ).append("<small>") //$NON-NLS-1$
                        .append("Past Process Name")
                        .append(": ") //$NON-NLS-1$
                        .append("mv")
                        .append("<br>")
                        .append("Past Process Id:")
                        .append("2311")
                        .append("<br>")
                        .append("Time Started: ")
                        .append("2016-06-25 16:15:27.707637")
                        .append( "<br>" )
                        .append("Time Ended: ")
                        .append("2016-06-25 16:16:04.707637")
                        .append( "<br>" )
                        .append("Files Wrote:")
                        .append("initrd.img,lib\\n,lib32\\n,lib64\\n,mnt\\n")
                        .append( "<br>" )
                        .append("Files Opened:")
                        .append("/etc/localtime,coreutile.mo,/etc/group,/etc/passwd,/etc/ld.so.cache,/etc/nsswitch.conf,/proc/filesystems");

                new AlertDialog.Builder( ctx ).setTitle("Details")
    ...
    public static final class ProcessSettings extends PreferenceActivity
    {
        ...
        void refreshSortType( )
        {
            ...
            switch ( type )
            {
                case ORDER_TYPE_NAME :
                    label = getString(R.string.lasthour);
                    break;
                case ORDER_TYPE_IMPORTANCE :
                    label = getString(R.string.lastday);
                    break;
                case ORDER_TYPE_MEM :
                    label = getString(R.string.lastweek);
                    break;
                //case ORDER_TYPE_CPU :
                ...
                PreferenceScreen preferenceScreen, Preference preference )
        {
            ...
            if ( PREF_KEY_DEFAULT_TAP_ACTION.equals( prefKey ) )
            {
                OnClickListener listener = new OnClickListener( ) {
